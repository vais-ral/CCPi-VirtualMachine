...
conda install -q -y -c ccpi/label/dev -c conda-forge -c paskino ccpi-preprocessing ccpi-reconstruction ccpi-regulariser ace python=3.6
#ccpi-quantification ccpi-segmentation #not for python 3.6
